...
public class PartnerCode implements Serializable {
    ...
    @TableGenerator(name = "CODENUM_GEN", table = "PARTNER_CODENUM_GEN_TBL", pkColumnName = "CODENUM_GEN_NAME", valueColumnName = "CODENUM_GEN_VAL", pkColumnValue = "CODENUM_GEN_PK", initialValue = 40000, allocationSize = 1)
