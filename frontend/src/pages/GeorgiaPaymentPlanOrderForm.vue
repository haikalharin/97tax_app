<template>
  <page :hideTopNav="true" :navType="'georgia-payment-plan-order-form'">
    <div class="container">
      <div class="my-3">
        <router-link to="/">
      ...
      <div class="mt-3">
        ...
        <p class="my-3">
          Complete the information below to prepare your payment plan
          application:
        </p>
      </div>
      <div class="billing-form">
        <div class="my-3">
          <h4 class="text-center font-weight-bolder">Billing Details</h4>
        </div>
        <div class="row">
      ...
      <p class="my-3">
        Your tax documents will come to the mailing address below with tracking.
        Georgia requires your signature:
      </p>
      <div class="mailing-form">
        <div class="my-3">
          <h4 class="text-center font-weight-bolder">Mailing Address</h4>
        </div>
      ...
      <div class="payment-form">
        <div class="my-3">
          <h4 class="text-center font-weight-bolder">Payment Information</h4>
        </div>
        <div class="row">
            ...
            <label>
              ...
              <span
                v-b-popover.hover.bottom="
                  'The total amount you owe can be found on notices received by the Department of Revenue. This amount includes all tax years.'
                "
              >
                <img
                  style="margin-top: -1rem"
                  src="./../assets/HelpBubble.png"
                />
              </span>
            </label>
            <input
              ...
              type="text"
            />
            <div class="text-danger pb-4" v-if="error.totalDebt">
              {{ error.totalDebt }}
            </div>
          </div>
          <div class="col-12 col-sm-4">
            <div class="mb-2">
              ...
              <div class="text-center font-weight-bold">to Georgia:</div>
            </div>
        ...
        <div class="row">
          <div class="col col-3">
            <label> Is this amount owed from a business? </label>
          </div>
          <div class="col col-2 amount-owe-selector">
            <select
              class="form-control"
              style="height: 100%"
      ...
      <div class="application-details-form">
        <div class="my-3">
          <h4 class="text-center font-weight-bolder">Application Details</h4>
        </div>
        <div class="row">
          <form-input-field
          ...
          <div v-if="orderInfo.married === true" class="col-12 col-sm-6">
          ...
          <generic-select-field
            ...
            helpText="This is the day of the month you prefer to make your normal monthly payment. It will not necessarily be the day your first payment is due because it takes time for Georgia to approve your payment plan application."
          >
      ...
      <p class="my-3">
        This is a one-time fee to prepare your application. No other charges are
        ever applied to this card.
      </p>
      <div class="card-form">
        <div class="my-3 card-form-header">
          <h4 class="text-center font-weight-bolder">Credit or Debit Card</h4>
          <div class="card-imgs">
        ...
        <div class="row">
          <div class="col-12 col-sm-3">
            ...
            <div class="partner-code-block">
              <div class="partner-conde-text">
                Partner Code (not required)
                <form-input-field
                  id="card__partner-code"
              ...
              <div class="form-group col-12 col-sm-3">
                <div class="d-flex align-items-center">
                  ...
                  <button
                    ...
                    style="height: 20px;border: 0;line-height: 1;margin-top: -1rem;"
      ...
      <div class="mt-3">
        <p style="color: #888; font-size: 20.25px" class="text-center">
          ...
          monthly payments go directly from you to Department of Revenue to pay
          off your tax balance. Personal data is never shared or sold and is
...
export default {
  ...
  data() {
    return {
      ...
      maxPaymentMonth: paymentPlansConfig.georgiaPaymentPlan.maxMonth,
      orderInfo: {
        billingFirstName: "",
        billingLastName: "",
        billingPhone: "",
  ...
  methods: {
      ...
      AXIOS.get(`/admin/salesList`).then((res) => {
        if (res.status == 200) {
          ...
          let index = list.findIndex((it) => {
            let condition_1 =
              it.onOff === true && it.product == "Georgia Payment Plan";
    ...
    initializePricings() {
      AXIOS.get(`/admin/productPrice?product_name=Georgia Payment Plan`).then((res) => {
        if (res.status == 200) {
          console.log(res);
    ...
    initializeCardinal() {
      ...
      Cardinal.on("payments.validated", (data, jwt) => {
        if (data.ActionCode === "SUCCESS" || data.ActionCode === "NOACTION") {
          ...
          AXIOS.post(`/ecommerce/authorize`, self.orderInfoTemp)
            ...
            .catch((e) => {
              if (e.response.status === 409) {
                this.orderInfo.failureReason = "Possible duplicate";
                this.orderInfoTemp = SiteUtils.updateAddress(
                  this.orderInfoTemp,
                  this.orderInfo,
                  this.addressType,
          ...
          this.orderInfoTemp.failureReason = "3-D Secure verification failure";
          self.errorMessages.push({
            show: true,
