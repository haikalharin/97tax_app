    ...
    <div class="find-out py-5">
      <div class="container" style="overflow: hidden">
          ...
          <div class="col-sm-7 col-12">
            ...
            >
              <h3 class="font-weight-bold text-uppercase text-center mb-4">
                FIND OUT <span class="highlight-text-color">INSTANTLY</span> IF
                YOU QUALIFY
              </h3>
              <div class="row mb-2">
                <div class="col-6">
        ...
        <div class="shown-xs-only" id="embedded_case-tracker1">
          <order-tracker isGeorgia="true"></order-tracker>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            <h1 class="mb-3 text-center font-weight-bold">
              What is the Georgia Payment Plan Request?
            </h1>
            <h4 class="light-gray text-center font-weight-bold">
              A Georgia payment plan requested with the Department of Revenue
              allows monthly payments on state income tax up to
        ...
        <div class="hidden-xs-only row my-2">
          <div class="col-sm-6 col-12">
            ...
            <p class="mb-4">
              The State of Georgia has provided access to payment plans.
              Individual taxpayers who owe the Georgia Department of Revenue can
              pay in monthly installments for up to
              {{ paymentPlanConfig.maxMonth }} months (five years). Payment plan
              requests setup through 97tax.com
              always calculate your payment at the full
              {{ paymentPlanConfig.maxMonth }} months and according to the
              published rules of the state.
            </p>
            <p class="mb-4">
              While Georgia generally will not need a financial statement, they
              may need some additional financial information later from you. In
              those cases, the state will contact you by phone or by mail at the
              provided address. Take a look at our FAQ further down this page
            ...
            <p>
              ...
              prepare all the Georgia Department of Revenue documents necessary
              to submit your payment plan. Within one business day, we'll mail
              your completed application to the mailing address you provide.
              Just sign the forms, drop it in the mail, and you're done.
            </p>
          </div>
          <div class="col-sm-6 col-12">
            ...
            <p class="mb-4">
              ...
              allowed by Georgia with a maximum of
            ...
            <p class="">
              <a href="#top-hero"
                ><span
                  class="font-weight-bold highlight-text-color"
            ...
            <p>
              The maximum amount you can owe to the Georgia Department of
              Revenue and still be eligible for an installment agreement is ${{
            ...
            <ul style="padding-inline-start: 20px">
              ...
              <li>Have filed all of your Georgia state tax returns.</li>
              <li>Not be in middle of bankruptcy.</li>
            </ul>
            <p>
              It's important to note that if you miss payments on the Georgia
              installment agreement, the state will cancel the payment plan.
            </p>
          </div>
        </div>
        <div class="shown-xs-only my-2">
          <georgia-payment-plan-ques></georgia-payment-plan-ques>
        </div>
        ...
        <div class="row py-3">
          <div class="col-sm-10 offset-sm-1 col-12 offset-0">
            ...
            <h4 class="text-center" style="font-size: 1.4rem">
              ...
              addresses within the state of Georgia. 97tax provides a prepaid
    ...
    <div class="frequently-asked-questions py-5">
      <div class="container">
        ...
        <div class="my-3" id="embedded_faq">
          <georgia-payment-plan-faqs></georgia-payment-plan-faqs>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      isQualified: true,
      planCreated: false,
      paymentPlanConfig: paymentPlansConfig.georgiaPaymentPlan,
      paymentPlanData: {
        firstName: "",
        lastName: "",
        phone: "",
        ...
        isCalifornia: false,
        isNewJersey: false,
        paymentMonths: paymentPlansConfig.georgiaPaymentPlan.maxMonth,
    ...
    confirmPlanSubmit() {
      ...
      paymentplanSubmitPromise
        .then(() => {
          ...
          if (this.isQualified) {
            this.$router.push("/georgia-payment-plan-order-form");
          }
        })
