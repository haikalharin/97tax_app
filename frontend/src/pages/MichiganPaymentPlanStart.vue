        ...
        <div class="row">
          <div class="col-12">
            <h5 class="font-weight-bold text-center">
              For a one-time enrollment fee, set up a Department of
              Treasury payment plan with small monthly payments.
            </h5>
          </div>
        </div>
      </div>
    ...
    <div class="find-out py-5">
      <div class="container" style="overflow: hidden">
          ...
          <div class="col-sm-5 hidden-xs-only">
            ...
            <div class="info-row d-flex mb-5 pr-4">
              ...
              <div class="info-text ml-4">
                ...
                <span
                  >New wage garnishments and <br />collections from
                  Michigan.</span
                >
              </div>
            </div>
            ...
            >
              ...
              >
                <h5 class="mb-1" style="font-size: 1.15rem">
                  How much do you owe Michigan State?
                </h5>
        ...
        <div class="shown-xs-only" id="embedded_case-tracker1">
          <order-tracker isMichigan="true"></order-tracker>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-sm-8 offset-sm-2 col-12 offset-0">
            <h1 class="mb-3 text-center font-weight-bold">
              What is a Michigan Installment Agreement?
            </h1>
            <h4 class="light-gray text-center font-weight-bold">
              The Michigan State payment plan program through the Michigan
              Department of Treasury allows monthly payments on state income tax
              over {{ paymentPlanConfig.maxMonth }} months. Here's more about
              how to set up a payment plan with the Michigan Department of
              Treasury:
            </h4>
          </div>
        </div>
        <div class="hidden-xs-only row my-2">
          <div class="col-sm-6 col-12">
            ...
            <p class="mb-4">
              The State of Michigan has provided access to payment plans.
              Individual taxpayers who owe up to $25,000 to the Michigan Department
              of Treasury can pay in monthly installments for up to
              {{ paymentPlanConfig.maxMonth }} months (five years). Installment
              agreements setup through 97tax.com always calculate your payment
              at the full {{ paymentPlanConfig.maxMonth }} months and according
              to the published rules of the Department of Treasury.
            </p>
            <p class="mb-4">
              While Michigan generally will not need a financial statement, they
              may need some additional financial information later from the
              taxpayer. In those cases, the Department of Treasury will contact you by phone or by
            ...
            <p>
              ...
              prepare all the Michigan Department of Treasury documents necessary to submit your
              payment plan. Within one business day, we'll mail your completed
              application to the mailing address you provide. Just sign the
              forms, drop it in the mail, and you're done. Easy!
            </p>
          </div>
          <div class="col-sm-6 col-12">
            ...
            <p>
              The maximum amount you can owe to the Michigan Department of Treasury and still be
              eligible for an installment agreement is $25,000. You also must:
            </p>
            <ul>
              <li>
              ...
              <li>have filed all of your Michigan state tax returns.</li>
            </ul>
            <p>
              It's important to note that if you miss payments on the Michigan
              installment agreement, the Department of Treasury will cancel the payment plan.
            </p>
          </div>
        </div>
        <div class="shown-xs-only my-2">
          <michigan-payment-plan-ques></michigan-payment-plan-ques>
        </div>
        ...
        <div class="row py-3">
          <div class="col-sm-10 offset-sm-1 col-12 offset-0">
            ...
            <h4 class="text-center">
              ...
              addresses within the state of Michigan. 97tax provides a prepaid
              mailing envelope along with your documents with the correct Department of Treasury
    ...
    <div class="frequently-asked-questions py-5">
      <div class="container">
        ...
        <div class="my-3" id="embedded_faq">
          <michigan-payment-plan-faqs></michigan-payment-plan-faqs>
        </div>
      </div>
    </div>
    ...
    confirmPlanSubmit() {
      ...
      paymentplanSubmitPromise
        .then(() => {
          ...
          if (this.isQualified) {
            this.$router.push("/michigan-payment-plan-order-form");
          }
        })
