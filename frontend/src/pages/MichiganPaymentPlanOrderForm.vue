<template>
  <page :hideTopNav="true" :navType="'michigan-payment-plan-order-form'">
    <div class="container">
      <div class="my-3">
        <router-link to="/">
        ...
        <div class="row">
          ...
          <div class="form-group col-12 col-sm-3">
            ...
            <input
              :class="[
                'form-control',
                error.billingMiddleInitialName ? 'is-invalid' : '',
              ]"
              :maxlength="1"
              v-model="orderInfo.billingMiddleInitialName"
              :error="error.billingMiddleInitialName"
              placeholder="Middle Initial"
              v-on:keypress="isLetter($event)"
            />

            <div
              v-if="error.billingMiddleInitialName"
              class="text-danger"
              style="margin-top: 10px"
            >
              {{ error.billingMiddleInitialName }}
            </div>
          </div>
          <div class="form-group col-12 col-sm-6">
            <label>
              ...
              <span
                v-b-popover.hover.bottom="
                  'Enter your name as it appears on your assessment notice.'
                "
              >
          ...
          <div class="form-group col-12 col-sm-3">
            ...
            <span
              v-b-popover.hover.bottom="
                'This should be a phone number that you can be reached at between 8:00 am and 5:00 pm.'
              "
            >
              <img src="./../assets/HelpBubble.png" />
            </span>
      ...
      <p class="my-3">
        We'll mail your tax documents to the address below with tracking.
        Michigan requires your physical signature:
      </p>
      ...
      <p class="my-3">
        You may adjust your monthly payment and re-payment duration below. We've
        calculated your minimum payment.
      </p>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-4">
            <div class="mb-2">
              ...
              <div class="text-center font-weight-bold">to Michigan State:</div>
            </div>
      ...
      <p class="my-3">
        ...
        Michigan will use this for identification.
      </p>
      <div class="tax-payer-information-form">
        <div class="my-3">
          <h4 class="text-center">Michigan Tax Payer Information</h4>
        </div>
        <div class="row">
          <div
            v-for="(assessmentNumber, index) in orderInfo.assessmentNumbers"
          ...
          >
            <label>
              ...
              <span
                v-b-popover.hover.bottom="
                  'The assessment numbers can be found on your notice.'
                "
              >
                <img src="./../assets/HelpBubble.png" />
              </span>
            ...
            <form-input-field
              v-model="orderInfo.assessmentNumbers[index]"
              :error="error.assessmentNumbers[index]"
              label=""
              placeholder="Assessment Number"
              :name="'assessmentNumbers' + index"
              type="tel"
              autocomplete="off"
            ></form-input-field>
          </div>
          <div
            ...
            :class="
              this.orderInfo.assessmentNumbers.length === 1
                ? 'col-sm-12'
                : 'col-sm-6'
            "
          >
            <button
              class="btn btn-primary btn-months-adjust ml-2"
              v-on:click="addingAssessmentNumber()"
            >
              +
            </button>
          ...
          <div
            ...
            v-if="this.orderInfo.assessmentNumbers.length > 1"
          >
            <button
              class="btn btn-primary btn-months-adjust ml-2"
              v-on:click="removeAssessmentNumber()"
            >
              -
            </button>
          ...
          <div class="form-group col-12 col-sm-6">
            ...
            <label>
              ...
              <span
                v-b-popover.hover.bottom="
                  'Your Treasury Account Number is located in the upper right hand corner of your assessment notice.  The account number will begin with an \'F\' or an \'S\'.'
                "
              >
                <img src="./../assets/HelpBubble.png" />
              </span>
            ...
            <form-input-field
              v-model="orderInfo.treasuryAccountNumber"
              :error="error.treasuryAccountNumber"
              placeholder="Enter Account Number"
              :name="'treasuryAccountNumber'"
              type="tel"
              autocomplete="off"
            ></form-input-field>
          </div>
          <div class="form-group col-12 col-sm-6">
            <generic-select-field
              ...
              label="Which day of month would you like your payment due?"
            >
          ...
          <div class="form-group col-12 col-sm-6">
            <yes-no-select-field
              ...
              :error="error.married"
              label="Are you married and filling jointly?"
            >
            </yes-no-select-field>
          </div>
          <div class="form-group col-12 col-sm-6">
            ...
            <div>
              <div class="d-flex align-items-center">
                <input
                  type="checkbox"
                  class="mr-2"
                  v-model="isBusinessForm"
                  v-on:click="validateBusinessForm()"
                />
          ...
          <div v-if="isBusinessForm" class="col-12 col-sm-6">
            <generic-select-field
              v-model="orderInfo.businessEntityType"
              :error="error.businessEntityType"
              label="Entity Type"
            >
          ...
          <div v-if="validateHasBusinessPartner()" class="col-12 col-sm-6">
            <yes-no-select-field
              v-model="orderInfo.hasBusinessPartner"
              :error="error.hasBusinessPartner"
      ...
      <div v-if="validateBusinessPartner()">
        <div v-for="(partner, index) in orderInfo.partners">
          <p class="my-3" p />
          <div class="bp-owner-shareholders-information-form">
            <div class="my-3">
              <h4 class="text-center">
                Business Partners, Owners, and Major Shareholders information
              </h4>
            </div>
            <div class="row">
              <div class="form-group col-12 col-sm-6">
                <label>
                  ...
                  <span
                    v-b-popover.hover.bottom="
                      'Please include your information as the first business partner'
                    "
                  >
                    <img src="./../assets/HelpBubble.png" />
                  </span>
                ...
                <form-input-field
                  v-model="orderInfo.partners[index].partnerName"
                  :error="error.partners[index].partnerName"
              ...
              <div class="form-group col-12 col-sm-6">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerTitle"
                  :error="error.partners[index].partnerTitle"
                  label="Partner Title"
                  placeholder="Partner Title"
                  :name="'partners[' + index + '].partnerTitle'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              ...
              <div class="form-group col-12 col-sm-3">
                <generic-select-field
                  v-model="orderInfo.partners[index].partnerEffectiveDay"
                  :error="error.partners[index].partnerEffectiveDay"
                  label="Day"
                >
                  <option v-for="index in 28" :value="index" :key="index">
                    {{ index }}
              ...
              <div class="form-group col-12 col-sm-3">
                <generic-select-field
                  v-model="orderInfo.partners[index].partnerEffectiveMonth"
                  :error="error.partners[index].partnerEffectiveMonth"
                  label="Month"
                >
              ...
              <div class="form-group col-12 col-sm-3">
                <generic-select-field
                  v-model="orderInfo.partners[index].partnerEffectiveYear"
                  :error="error.partners[index].partnerEffectiveYear"
                  label="Year"
                >
              ...
              <div class="form-group col-12 col-sm-6">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerAddress1"
                  :error="error.partners[index].partnerAddress1"
                  label="Partner Address Line 1"
                  placeholder="Partner Address Line 1"
                  name="'partners[' + index + '].partnerAddress1'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              <div class="form-group col-12 col-sm-6">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerAddress2"
                  :error="error.partners[index].partnerAddress2"
                  label="Partner Address Line 2"
                  placeholder="Partner Address Line 2"
                  :name="'partners[' + index + '].partnerAddress2'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              <div class="form-group col-12 col-sm-4">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerCity"
                  :error="error.partners[index].partnerCity"
                  label="Partner City"
                  placeholder="Partner City"
                  name="'partners[' + index + '].partnerCity'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              <div class="form-group col-12 col-sm-4">
                <state-select-field
                  v-model="orderInfo.partners[index].partnerState"
                  classes="state_select_field"
                  :error="error.partners[index].partnerState"
                  name="'partners[' + index + '].partnerState'"
                  label="Partner State"
                ></state-select-field>
              </div>
              <div class="form-group col-12 col-sm-4">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerZip"
                  :error="error.partners[index].partnerZip"
                  :maxlength="5"
                  v-mask="'#####'"
                  label="Partner ZIP Code"
                  placeholder="Partner ZIP Code"
                  name="'partners[' + index + '].partnerZip'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              <div class="form-group col-12 col-sm-6">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerPhoneNumber"
                  :error="error.partners[index].partnerPhoneNumber"
                  label="Partner Phone Number"
                  placeholder="Partner Phone Number"
                  v-mask="'###-###-####'"
                  name="'partners[' + index + '].partnerPhoneNumber'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              <div class="form-group col-12 col-sm-6">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerSsn"
                  :error="error.partners[index].partnerSsn"
                  label="Partner SSN"
                  placeholder="000-00-0000"
                  v-mask="'###-##-####'"
                  name="'partners[' + index + '].partnerSsn'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              <div class="form-group col-12 col-sm-6">
                <form-input-field
                  v-model="orderInfo.partners[index].partnerPercentOwnership"
                  :error="error.partners[index].partnerPercentOwnership"
                  label="Partner Percent of Ownership"
                  placeholder="Partner Percent of Ownership"
                  name="'partners[' + index + '].partnerPercentOwnership'"
                  type="tel"
                  autocomplete="off"
                ></form-input-field>
              </div>
              <div class="form-group col-12 col-sm-12">
                <button
                  class="btn btn-primary btn-months-adjust ml-2"
                  v-on:click="addingPartner()"
                >
                  +
                </button>
                Add Additional Partner
              </div>
              <div class="form-group col-12 col-sm-12" v-if="index > 0">
                <button
                  class="btn btn-primary btn-months-adjust ml-2"
                  v-on:click="removePartner()"
                >
                  -
                </button>
                Remove this partner
      ...
      <p class="my-3" p />
      <div class="bank-information-form">
        <div class="my-3">
        ...
        <div class="row">
          ...
          <div class="form-group col-12 col-sm-6">
            <form-input-field
              v-model="orderInfo.bankAddress1"
              :error="error.bankAddress1"
          ...
          <div class="form-group col-12 col-sm-6">
            <form-input-field
              v-model="orderInfo.bankAddress2"
              :error="error.bankAddress2"
          ...
          <div class="form-group col-12 col-sm-4">
            <form-input-field
              v-model="orderInfo.bankCity"
              :error="error.bankCity"
              label="Bank City"
          ...
          <div class="form-group col-12 col-sm-4">
            <state-select-field
              v-model="orderInfo.bankState"
              :error="error.bankState"
              label="Bank State"
      ...
      <p class="my-3" p />
      <div class="employer-information-form">
        <div class="my-3">
      ...
      <div class="mt-3">
        <p style="color: #888">
          ...
          monthly payments go directly from you to the Michigan FTB to pay off
          your tax balance. Personal data is never shared or sold and is fully
          encrypted and secure in accordance with our Privacy Policy.
        </p>
        <!-- <p style="color: #888;">Your personal data will be used only to prepare your payment plan application and process the one-time fee of $97 today. We will begin working on your application immediately and update you within 1 business day by email. Nothing else will be charged to this card. Your normal monthly payments will go directly from you to the Michigan FTB. Personal data is never shared or sold and is fully encrypted and secure in accordance with our Privacy Policy.</p> -->
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      productPrice: 0,
      totalDebtPrevValue: "",
      paymentPlanConfig: paymentPlansConfig.michiganPaymentPlan,
      maxPaymentMonth: paymentPlansConfig.michiganPaymentPlan.maxMonth,
      orderInfo: {
        billingFirstName: "",
        billingMiddleInitialName: "",
        billingLastName: "",
        billingPhone: "",
        shippingFirstName: "",
        shippingLastName: "",
        ...
        isGeorgia: false,
        isIllinois: false,
        paymentMonths: paymentPlansConfig.michiganPaymentPlan.maxMonth,
        ssn: "",
        married: false,
        spouseFirstName: "",
        spouseLastName: "",
  ...
  methods: {
      ...
      AXIOS.get(`/admin/salesList`).then((res) => {
        if (res.status == 200) {
          ...
          let index = list.findIndex((it) => {
            let condition_1 =
              it.onOff === true && it.product == "Michigan Payment Plan";
    ...
    initializePricings() {
      AXIOS.get(`/admin/productPrice?product_name=Michigan Payment Plan`).then((res) => {
        if (res.status == 200) {
          console.log(res);
    ...
    checkTotalDebtQualification() {
      ...
      if (!paymentPlan.valid) {
        ...
        this.error.totalDebt =
          "This amount must be between $500 and $25,000.00 to qualify.";
        return false;
      }
          ...
          AXIOS.post(`/ecommerce/authorize`, self.orderInfoTemp)
            .then((response) => {
              if (response.data.success) {
                ...
                self.orderInfoTemp.failureReason = response.data.message;
    ...
    validateForm() {
      ...
      let checkPartnerPhoneNumberErrorMsg = "";
      for (let i = 0; i < this.orderInfo.partners.length; i++) {
        if (!SiteUtils.validateSsn(this.orderInfo.partners[i].partnerSsn)) {
          this.error.partners[i].partnerSsn = true;
          this.hasErrors = true;
        }

        checkPartnerPhoneNumberErrorMsg = SiteUtils.validatePhone(
          this.orderInfo.partners[i].partnerPhoneNumber
        );
        if (checkPartnerPhoneNumberErrorMsg) {
          this.error.partners[i].partnerPhoneNumber =
            checkPartnerPhoneNumberErrorMsg;
          this.hasErrors = true;
        }
      }
    ...
    validateBusinessPartner() {
      if (
        (this.orderInfo.businessEntityType == "Corporation" ||
          this.orderInfo.businessEntityType == "Partnership") &&
        this.orderInfo.hasBusinessPartner
      ) {
        if (this.orderInfo.partners.length == 0) {
          this.pushBussinessPartner();
        }
        return true;
      } else {
        this.orderInfo.partners = [];
        this.error.partners = [];
        return false;
      }
    },

    validateHasBusinessPartner() {
      if (
        this.isBusinessForm &&
        (this.orderInfo.businessEntityType == "Corporation" ||
          this.orderInfo.businessEntityType == "Partnership")
        ...
        this.orderInfo.hasBusinessPartner = false;
        return false;
      }
    },
    ...
    validateBusinessForm() {
      if (!this.isBusinessForm) {
        this.orderInfo.partners = [];
        this.orderInfo.businessEntityType = "";
        this.orderInfo.hasBusinessPartner = false;
        this.error.partners = [];
      }
    },
    ...
    removeAssessmentNumber() {
      var assessmentNumber = this.orderInfo.assessmentNumbers.length;
      if (assessmentNumber === 1) {
        return;
      }

      this.orderInfo.assessmentNumbers.splice(
        this.orderInfo.assessmentNumbers.length - 1,
        1
      );
      this.error.assessmentNumbers.splice(
        this.error.assessmentNumbers.length - 1,
        1
      );
    },

    addingAssessmentNumber() {
      var assessmentNumber = this.orderInfo.assessmentNumbers.length;
      if (assessmentNumber === 11) {
        return;
      } else {
        this.orderInfo.assessmentNumbers.push("");
        this.error.assessmentNumbers.push("");
      }
    },

    removePartner(index) {
      this.orderInfo.partners.splice(index, 1);
      this.error.partners.splice(index, 1);
    },

    addingPartner() {
      var partnerLength = this.orderInfo.partners.length;
      if (partnerLength === 3) {
        return;
      } else {
        this.pushBussinessPartner();
    ...
    pushBussinessPartner() {
      this.orderInfo.partners.push({
        partnerName: "",
        partnerTitle: "",
        partnerEffectiveDay: "",
        partnerEffectiveMonth: "",
        partnerEffectiveYear: "",
        partnerAddress1: "",
        partnerAddress2: "",
        partnerCity: "",
        partnerState: "",
        ...
        partnerPhoneNumber: "",
        partnerSsn: "",
        partnerPercentOwnership: "",
      });

      this.error.partners.push({
        partnerName: "",
        partnerTitle: "",
        partnerEffectiveDay: "",
        partnerEffectiveMonth: "",
      ...
      AXIOS.put(`/ecommerce/presave`, this.orderInfoTemp)
        .then((res) => {
          ...
          AXIOS.put(`/paymentplan`, {
            ...
            isMichigan: this.orderInfo.isMichigan,
    ...
    postOrderInfo() {
      ...
      if (this.isBusinessForm) {
        this.orderInfo.businessEntityType = this.orderInfo.businessEntityType;
        this.orderInfo.hasBusinessPartner = this.orderInfo.hasBusinessPartner;
        if (
          this.orderInfo.businessEntityType == "Corporation" &&
          this.orderInfo.hasBusinessPartner
        ) {
          this.orderInfo.partnerName = this.orderInfo.partnerName;
          this.orderInfo.partnerTitle = this.orderInfo.partnerTitle;
          this.orderInfo.partnerEffectiveDay =
            this.orderInfo.partnerEffectiveDay;
          this.orderInfo.partnerEffectiveMonth =
            this.orderInfo.partnerEffectiveMonth;
          this.orderInfo.partnerEffectiveYear =
            this.orderInfo.partnerEffectiveYear;
          this.orderInfo.partnerAddress1 = this.orderInfo.partnerAddress1;
          this.orderInfo.partnerAddress2 = this.orderInfo.partnerAddress2;
          this.orderInfo.partnerCity = this.orderInfo.partnerCity;
          this.orderInfo.partnerZip = this.orderInfo.partnerZip;
          this.orderInfo.partnerState = this.orderInfo.partnerState;
          this.orderInfo.partnerPhoneNumber = this.orderInfo.partnerPhoneNumber;
          this.orderInfo.partnerSsn = this.orderInfo.partnerSsn;
          this.orderInfo.partnerPercentOwnership =
            this.orderInfo.partnerPercentOwnership;
        }
      }
...
.tax-payer-information-form,
.bp-owner-shareholders-information-form,
.card-form {
