<template>
  <page :hideTopNav="true" :navType="'california-payment-plan-order-form'">
    <div class="container">
      <div class="my-3">
        <router-link to="/">
      ...
      <p class="my-3">
        ...
        California requires your physical signature:
      </p>
      ...
      <div class="application-details-form">
        ...
        <div class="row">
          <form-input-field
            ...
            :error="error.ssn"
            label="Social Security Number or FTB ID"
          ...
          <yes-no-select-field
            ...
            label="Do you file jointly with a spouse or RDP?"
          >
          </yes-no-select-field>
          ...
          <generic-select-field
            ...
            helpText="This is the day of the month you prefer to make your normal monthly payment. It will not necessarily be the day your first payment is due because it takes time for California to approve your payment plan application."
          >
      ...
      <div class="mt-3">
        <p style="color: #888">
          ...
          monthly payments go directly from you to the California FTB to pay off
        ...
        <!-- <p style="color: #888;">Your personal data will be used only to prepare your payment plan application and process the one-time fee of $97 today. We will begin working on your application immediately and update you within 1 business day by email. Nothing else will be charged to this card. Your normal monthly payments will go directly from you to the California FTB. Personal data is never shared or sold and is fully encrypted and secure in accordance with our Privacy Policy.</p> -->
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      maxPaymentMonth: paymentPlansConfig.californiaPaymentPlan.maxMonth,
      productPrice: 0,
      orderInfo: {
        billingFirstName: "",
        billingLastName: "",
  ...
  methods: {
      ...
      AXIOS.get(`/admin/salesList`).then((res) => {
        if (res.status == 200) {
          ...
          let index = list.findIndex((it) => {
            let condition_1 =
              it.onOff === true && it.product == "California Payment Plan";
    ...
    initializePricings() {
      AXIOS.get(`/admin/productPrice?product_name=California Payment Plan`).then((res) => {
        if (res.status == 200) {
          console.log(res);
