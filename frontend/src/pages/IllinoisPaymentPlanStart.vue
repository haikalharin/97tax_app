<template>
  <page :navType="'illinois-payment-plan'">
    <div id="top-hero" class="top-hero pt-5 pb-4">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h1 class="font-weight-bold text-uppercase text-center">
              OWE ILLINOIS TAXES <br />& NEED A PAYMENT PLAN?
            </h1>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <h5 class="font-weight-bold text-center" style="font-size: 1.23rem">
              For a one-time enrollment fee, set up a Department of Revenue
              payment plan with small monthly payments
              <!-- For a one-time enrollment fee of $97, set up a Department of Revenue installment plan with small monthly payments. -->
            </h5>
          </div>
        </div>
      </div>
    ...
    <div class="find-out py-5">
      <div class="container" style="overflow: hidden">
          ...
          <div class="col-sm-5 hidden-xs-only">
            <div class="info-row d-flex my-5 pr-4">
              ...
              <div class="info-text ml-4">
                ...
                <span
                  >Enroll now. Our cases are<br />
                  done within 1 business day.</span
                >
              </div>
            </div>
            <div class="info-row d-flex mb-5 pr-4">
              ...
              <div class="info-text ml-4">
                ...
                <span
                  >New wage garnishments and<br />
                  collections from Illinois</span
                >
              </div>
            </div>
              ...
              <div style="margin-left: 3%">
                ...
                <div class="flag-wrapper">
                  ...
                  <span class="arial-17 times-31"
                    >Amounts over ${{
                      formatCurrencyWithCommas(paymentPlanConfig.maxAmount)
                    }}
        ...
        <div class="shown-xs-only" id="embedded_case-tracker1">
          <order-tracker isIllinois="true"></order-tracker>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-sm-8 offset-sm-2 col-12 offset-0">
            <h1 class="mb-3 text-center font-weight-bold">
              What is an Illinois Installment Agreement?
            </h1>
            <h4 class="light-gray text-center font-weight-bold">
              An Illinois installment payment plan request with the Department
              of Revenue allows monthly payments on state income tax over a
              period of time. Here's more about how to request a payment plan:
            </h4>
          </div>
        </div>
        <div class="hidden-xs-only row my-2">
          <div class="col-sm-6 col-12">
            ...
            <p class="mb-4">
              The State of Illinois has provided access to payment plans.
              Individual and business taxpayers who are able to make a "good
              faith down payment" can pay the remaining balance monthly. 97tax
              calculates your down payment as at least 5% of your balance, and
              the remaining amount paid over a maximum of
              {{ paymentPlanConfig.maxMonth }} months to make a reasonable offer
              to the State. During checkout, you can choose to increase these
              amounts and select a monthly payment date.
            </p>
            <p class="mb-4">
              Illinois will not need a financial statement unless your remaining
              balance after your down payment is over $5,000. 97tax includes the
              appropriate financial statement in your tax packet. Take a look at
              our FAQ further down this page for more information.
            </p>
            <p>
              Hiring a local attorney is expensive and unnecessary, and trying
              it yourself can cause months of delay and even more frustration
              and cost. We prepare all the Illinois Department of Revenue
              documents necessary to submit your payment plan. Within one
              business day, we'll mail your completed application to the mailing
              address you provide. Just sign the forms, drop it in the mail, and
              you're done.
            </p>
          </div>
          <div class="col-sm-6 col-12">
            ...
            <p class="mb-5">
              By applying for a payment plan online through
              97tax.com, our system will automatically calculate the minimum payment
              allowed by Illinois with a maximum of
            ...
            <p>
              The maximum amount you can owe to the Department of Revenue and
              still be eligible for an installment agreement is ${{
                formatCurrencyWithCommas(paymentPlanConfig.maxAmount)
              }}. You also must:
            </p>
            <ul style="padding-inline-start: 20px">
              ...
              <li>Have filed all of your Illinois state tax returns.</li>
            </ul>
            <p>
              It's important to note that if you miss payments on the Illinois
              installment agreement, the state will cancel the payment plan.
            </p>
          </div>
        </div>
        <div class="shown-xs-only my-2">
          <illinois-payment-plan-ques></illinois-payment-plan-ques>
        </div>
      ...
      <div class="container">
        <div class="row py-3">
          <div class="col-sm-10 offset-sm-1 col-12 offset-0">
            <h1 class="mb-4 text-center" style="font-weight: 800">
              Did you know?
            </h1>
            <h4 class="text-center" style="font-size: 1.4rem">
              Normal payments and payment plan applications go to different
              addresses within the state of Illinois. 97tax provides a prepaid
              mailing envelope along with your documents with the correct
              Department of Revenue address to avoid delays.
            </h4>
          </div>
        </div>
      </div>
    ...
    <div class="frequently-asked-questions py-5">
      <div class="container">
        ...
        <div class="my-3" id="embedded_faq">
          <illinois-payment-plan-faqs></illinois-payment-plan-faqs>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      paymentPlanData: {
        ...
        isCalifornia: false,
        isNewJersey: false,
        paymentMonths: paymentPlansConfig.illinoisPaymentPlan.maxMonth,
  ...
  methods: {
    ...
    paymentPlanSubmit() {
      ...
      let checkEmailErrorMsg = SiteUtils.validateEmail(
        this.paymentPlanData.email
      );
      if (checkEmailErrorMsg) {
        this.errors.email = checkEmailErrorMsg;
        this.hasErrors = true;
      }
    ...
    confirmPlanSubmit() {
      ...
      const goodFaithPayment = Number(((totalDebt * 5) / 100).toFixed(2));
      ...
      paymentplanSubmitPromise
        .then(() => {
          ...
          if (this.isQualified) {
            this.$router.push("/illinois-payment-plan-order-form");
          }
        })
