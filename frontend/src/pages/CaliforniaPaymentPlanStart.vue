        ...
        <div class="row">
          <div class="col-12">
            <h5 class="font-weight-bold text-center">
              For a one-time enrollment fee, set up a California FTB payment
              plan with small monthly payments
              <!-- For a one-time fee of $97, we'll prepare your FTB payment plan application. -->
            </h5>
          </div>
        </div>
      </div>
    ...
    <div class="find-out py-5">
      <div class="container" style="overflow: hidden">
          ...
          <div class="col-sm-5 hidden-xs-only">
            ...
            <div class="info-row d-flex mb-5 pr-4">
              ...
              <div class="info-text ml-4">
                ...
                <span
                  >New wage garnishments and collections from California.</span
                >
              </div>
            </div>
            ...
            >
              ...
              >
                <h5 class="mb-1" style="font-size: 1.15rem">
                  How much do you owe California State?
                </h5>
        ...
        <div class="shown-xs-only" id="embedded_case-tracker1">
          <order-tracker isCalifornia="true"></order-tracker>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-sm-8 offset-sm-2 col-12 offset-0">
            <h1 class="mb-3 text-center font-weight-bold">
              What is the California State Payment plan?
            </h1>
            <h4 class="light-gray text-center font-weight-bold">
              The California State payment plan program through the FTB allows
              monthly payments on state income tax up to $25,000 over
              {{ paymentPlanConfig.maxMonth }} months. Here's more about how to
              set up a payment plan with the FTB:
            </h4>
          </div>
        </div>
        <div class="hidden-xs-only row my-2">
          <div class="col-sm-6 col-12">
            ...
            <p class="mb-4">
              The State of California has provided access to payment plans.
              Individual taxpayers who owe up to $25,000 to the California
              FTB(Franchise Tax Board) can pay in monthly installments for up to
              ...
              to the published rules of the FTB.
            </p>
            <p class="mb-4">
              While California generally will not need a financial statement,
              they may need some additional financial information later from the
              taxpayer. In those cases, the FTB will contact you by phone or by
            ...
            <p>
              ...
              prepare all the California FTB documents necessary to submit your
          ...
          <div class="col-sm-6 col-12">
            ...
            <p>
              The maximum amount you can owe to the California FTB and still be
            ...
            <ul>
              ...
              <li>have filed all of your California state tax returns.</li>
            </ul>
            <p>
              It's important to note that if you miss payments on the California
              installment agreement, the FTB will cancel the payment plan.
            </p>
          </div>
        </div>
        <div class="shown-xs-only my-2">
          <california-payment-plan-ques></california-payment-plan-ques>
        </div>
        ...
        <div class="row py-3">
          <div class="col-sm-10 offset-sm-1 col-12 offset-0">
            ...
            <h4 class="text-center">
              ...
              addresses within the state of California. 97tax provides a prepaid
              mailing envelope along with your documents with the correct FTB
    ...
    <div class="frequently-asked-questions py-5">
      <div class="container">
        ...
        <div class="my-3" id="embedded_faq">
          <california-payment-plan-faqs></california-payment-plan-faqs>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      isQualified: true,
      planCreated: false,
      paymentPlanConfig: paymentPlansConfig.californiaPaymentPlan,
      paymentPlanData: {
        firstName: "",
        lastName: "",
        phone: "",
        ...
        isIllinois: false,
        isGeorgia: false,
        paymentMonths: paymentPlansConfig.californiaPaymentPlan.maxMonth,
    ...
    confirmPlanSubmit() {
      ...
      paymentplanSubmitPromise
        .then(() => {
          ...
          if (this.isQualified) {
            this.$router.push("/california-payment-plan-order-form");
          }
        })
