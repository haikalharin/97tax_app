    ...
    <div class="container">
      ...
      >
        <div class="col-6 col-md-3 mb-4">
          <div class="d-flex flex-column">
            <div v-if="!subDomainActive" class="d-flex flex-column">
              <router-link class="mb-0" to="/">Home</router-link>
              <router-link class="mb-0" to="/faqs"
                >Frequently Asked Questions</router-link
              >
              <router-link class="mb-0" to="/about-us">About Us</router-link>
              <router-link class="mb-0" to="/payment-plan"
                >Payment Plans</router-link
              >
              <router-link class="mb-0" to="/penalty-waiver"
        ...
        <div class="col-6 col-md-6 mb-4">
          <div class="d-flex flex-column">
            <a class="pointer mb-0" @click="goToNextPage('/terms-of-service')"
              >Terms of Service</a
            >
            <router-link class="mb-0" v-if="!subDomainActive" to="/cancel"
              >Cancellations and Refunds</router-link
            >
            <router-link class="mb-0" v-if="!subDomainActive" to="/services"
              >Services</router-link
            >
            <a class="pointer mb-0" @click="goToNextPage('/privacy-policy')"
              >Privacy Policy</a
            >
            <router-link class="mb-0" v-if="!subDomainActive" to="/contact-us"
